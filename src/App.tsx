    ...
    <HelmetProvider>
      <div className="min-h-screen font-sans text-slate-900 bg-white selection:bg-primary/10 selection:text-primary">
        <Helmet>
          ...
          <meta property="og:image" content="https://www.newclimaar.com.br/images/logo.png?v=5" />
          ...
          <meta name="twitter:image" content="https://www.newclimaar.com.br/images/logo.png?v=5" />
            ...
            {`
              {
                ...
                "image": "https://www.newclimaar.com.br/images/logo.png?v=5",
          ...
          <div className="container mx-auto px-4">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
              <div className="space-y-6">
                <img src="/images/logo.png?v=5" alt="New Clima Ar" className="h-16 w-auto brightness-0 invert" />
