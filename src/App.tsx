...
type PageId = 'home'
  ...
  | 'blog-obra-limpa'
  | 'blog-quarto'
  | 'blog-convencional-inverter'
  | 'blog-empresas'
  | 'blog-pmoc-obrigatorio'
  | 'blog-multa-pmoc'
  | 'blog-pmoc-condominio'
  | 'blog-custo-pmoc'
  | 'blog-custo-instalacao'
  | 'blog-qual-ac'
  | 'blog-split-multi-split'
  | 'blog-manutencao-consequencias'
  | 'blog-saude'
  | 'blog-dormir'
  | 'blog-consumo'
  | 'blog-quanto-gasta'
  | 'blog-mau-cheiro'
  | 'blog-desliga-sozinho'
  | 'blog-vida-util'
  | 'blog-temperatura'
  | 'blog-funcao-dry'
  | 'blog-gas'
  ...
  | 'blog-limpeza-sp'
  | 'blog-conserto-sp'
  | 'blog-manutencao-preventiva-sp'
  | 'blog-sala'
  | 'blog-escritorio-sp'
  | 'blog-custo-limpeza'
  | 'blog-barulhento'
  | 'blog-nao-liga'
  | 'manutencao-santo-andre'
  | 'limpeza-santo-andre'
  | 'pmoc-santo-andre'
  | 'manutencao-sao-bernardo'
  | 'limpeza-sao-bernardo'
  | 'pmoc-sao-bernardo'
  | 'manutencao-sao-caetano'
  | 'limpeza-sao-caetano'
  | 'pmoc-sao-caetano'
  | 'manutencao-diadema'
  | 'limpeza-diadema'
...
function SitemapView({ navigate }: { navigate: (p: PageId) => void }) {
  ...
  const blogLinks = [
    ...
    { label: 'Ar Condicionado Faz Mal à Saúde?', page: 'blog-saude' as PageId },
    { label: 'Dormir com Ar Condicionado Faz Mal?', page: 'blog-dormir' as PageId },
    { label: 'Ar Condicionado Gasta Mais de Dia ou à Noite?', page: 'blog-consumo' as PageId },
    { label: 'Quanto Gasta um Ar Condicionado Inverter por Mês?', page: 'blog-quanto-gasta' as PageId },
    { label: 'Ar Condicionado com Mau Cheiro: Causas e Solução', page: 'blog-mau-cheiro' as PageId },
    { label: 'Ar Condicionado Desliga Sozinho: 8 Causas', page: 'blog-desliga-sozinho' as PageId },
    { label: 'Vida Útil do Ar Condicionado: Quanto Dura?', page: 'blog-vida-util' as PageId },
    { label: 'Temperatura Ideal do Ar Condicionado', page: 'blog-temperatura' as PageId },
    { label: 'Função Dry do Ar Condicionado: Para Que Serve?', page: 'blog-funcao-dry' as PageId },
    { label: 'Gás R32 x R410A: Diferenças e Qual Está no Seu Aparelho', page: 'blog-gas' as PageId },
    { label: 'Ar Condicionado Não Gela: 7 Causas e Como Resolver', page: 'blog-nao-gela' as PageId },
    { label: 'Ar Condicionado Pingando Água: Causas e Solução', page: 'blog-pingando-agua' as PageId },
    { label: 'Limpeza de Ar Condicionado em SP: Preços e Frequência', page: 'blog-limpeza-sp' as PageId },
    { label: 'Conserto de Ar Condicionado em SP: Diagnóstico Gratuito', page: 'blog-conserto-sp' as PageId },
    { label: 'Manutenção Preventiva de Ar Condicionado em SP', page: 'blog-manutencao-preventiva-sp' as PageId },
    { label: 'Ar Condicionado para Sala: Qual BTU e Onde Instalar', page: 'blog-sala' as PageId },
    { label: 'Ar Condicionado para Escritório em SP', page: 'blog-escritorio-sp' as PageId },
    { label: 'Quanto Custa a Limpeza de Ar Condicionado em SP?', page: 'blog-custo-limpeza' as PageId },
    { label: 'Ar Condicionado Fazendo Barulho: Causas e Solução', page: 'blog-barulhento' as PageId },
    { label: 'Ar Condicionado Não Liga: O Que Verificar', page: 'blog-nao-liga' as PageId },
  ]
