    ...
    <HelmetProvider>
      <div className="min-h-screen font-sans text-slate-900 bg-white selection:bg-primary/10 selection:text-primary">
        <Helmet>
          ...
          <meta property="og:image" content="https://www.newclimaar.com.br/logo-newclima.png?v=3" />
          ...
          <meta name="twitter:image" content="https://www.newclimaar.com.br/logo-newclima.png?v=3" />
            ...
            {`
              {
                ...
                "image": "https://www.newclimaar.com.br/logo-newclima.png?v=3",
          ...
          <div className="container mx-auto px-4">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
              <div className="space-y-6">
                <img src="/logo-newclima.png?v=3" alt="New Clima Ar" className="h-16 w-auto brightness-0 invert" />
