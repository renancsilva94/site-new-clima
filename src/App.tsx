      ...
      <div className="min-h-screen font-sans text-slate-900 bg-white selection:bg-primary/10 selection:text-primary">
        ...
        <main>
          {(() => {
            ...
            if (p === '/assistencia-tecnica-ar-condicionado-sp') return <SegmentoView slug="assistencia-tecnica-ar-condicionado-sp"
