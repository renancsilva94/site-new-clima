    ...
    <div className="overflow-x-auto my-6">
      <table className="w-full border-collapse text-sm">
        ...
        <tbody>
          ...
          <tr className="bg-slate-50"><td className="p-3 border border-slate-200">Higienização split 9.000 BTUs</td><td className="p-3 border border-slate-200">Evaporador + bandeja + dreno</td><td className="p-3 border border-slate-200 font-bold text-primary">R$ 500 (1 unidade)</td></tr>
          <tr className="bg-white"><td className="p-3 border border-slate-200">Higienização split 12.000-18.000 BTUs</td><td className="p-3 border border-slate-200">Evaporador + bandeja + dreno</td><td className="p-3 border border-slate-200 font-bold text-primary">R$ 500 (1 unidade)</td></tr>
          <tr className="bg-slate-50"><td className="p-3 border border-slate-200">Higienização cassete</td><td className="p-3 border border-slate-200">Limpeza completa interna</td><td className="p-3 border border-slate-200 font-bold text-primary">R$ 550</td></tr>
          <tr className="bg-white"><td className="p-3 border border-slate-200">Higienização piso-teto acima de 60.000 BTUs</td><td className="p-3 border border-slate-200">Com uso de bolsa de contenção</td><td className="p-3 border border-slate-200 font-bold text-primary">R$ 600</td></tr>
          <tr className="bg-slate-50"><td className="p-3 border border-slate-200">Higienização para clínica (ANVISA)</td><td className="p-3 border border-slate-200">Normas sanitárias + certificado</td><td className="p-3 border border-slate-200 font-bold text-primary">R$ 550 a R$ 700</td></tr>
          <tr className="bg-white"><td className="p-3 border border-slate-200">Pacote 3+ equipamentos</td><td className="p-3 border border-slate-200">Desconto por volume</td><td className="p-3 border border-slate-200 font-bold text-success">R$ 400/unid.</td></tr>
        </tbody>
      </table>
    </div>
