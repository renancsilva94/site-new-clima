...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://www.newclimaar.com.br/ar-condicionado-academia-sp',
  },
  openGraph: {
    title: 'Ar Condicionado para Academias em São Paulo | New Clima',
    description: 'Sistemas de alta capacidade para academias e estúdios em SP. PMOC e manutenção frequente para alta ocupação. (11) 96346-2516.',
    url: 'https://www.newclimaar.com.br/ar-condicionado-academia-sp',
    type: 'website',
...
export default function Page() {
  return <App pathname="/ar-condicionado-academia-sp" />
}
