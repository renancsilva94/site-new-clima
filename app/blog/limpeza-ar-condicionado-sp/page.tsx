...
export const metadata: Metadata = {
  ...
  description: 'Tudo sobre limpeza de ar condicionado em São Paulo: quanto custa, com que frequência fazer, o que está incluso e por que é essencial para a saúde. A partir de R$ 500.',
  alternates: {
