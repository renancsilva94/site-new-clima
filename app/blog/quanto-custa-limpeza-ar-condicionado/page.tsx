...
export const metadata: Metadata = {
  ...
  description: 'Tabela completa de preços de limpeza de ar condicionado em São Paulo em 2026. O que está incluso, frequência ideal e como agendar. A partir de R$ 500.',
  alternates: {
