...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://www.newclimaar.com.br/ar-condicionado-farmacia-sao-paulo',
  },
  openGraph: {
    title: 'Ar Condicionado para Farmácias em São Paulo | New Clima',
    description: 'Instalação e manutenção de ar condicionado para farmácias em SP. Temperatura controlada para medicamentos, PMOC conforme ANVISA. (11) 96346-2516.',
    url: 'https://www.newclimaar.com.br/ar-condicionado-farmacia-sao-paulo',
    type: 'website',
...
export default function Page() {
  return <App pathname="/ar-condicionado-farmacia-sao-paulo" />
}
